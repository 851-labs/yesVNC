 ...
 * ------v------*/
    ...
    credentials(e) {
        ...
        const configuredUsername = UI.getSetting('username');
        if (configuredUsername) {
            document.getElementById('noVNC_username_input').value = configuredUsername;
        }
    ...
    setCredentials(e) {
        ...
        WebUtil.setSetting('username', username);
        UI.reconnectPassword = password;
        document.getElementById('noVNC_credentials_dlg')
            .classList.remove('noVNC_open');
    },
